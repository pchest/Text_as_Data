...
df.tweets<-read.csv("https://raw.githubusercontent.com/pchest/Text_as_Data/master/bullying.csv", stringsAsFactors = F)
...
comparison.cloud(tdm, max.words=100, colors=c("red", "blue")) # Function is from the wordcloud package
...
## Comments:
# linear vs radial kernels, radial can over fit
# linear kernel is faster
# nfold is the number of times you break it into samples
